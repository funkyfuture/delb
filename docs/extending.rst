...
plugin for poetry_.
See also the :mod:`delb.plugins.contrib.https_loader` module as example a plugin
module.
...
.. _provide entrypoint metadata: metadata: https://packaging.python.org/guides/creating-and-discovering-plugins/#using-package-metadata
